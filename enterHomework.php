...
?>
    		...
    		<form action="./enterHomework.php" method="post">
                ...
                <input type="number" name="hPageNr"> <?php if(!empty($_POST) && $_POST["hPageNr"] == ""){ echo("Bitte gib eine Seite an."); } ?>
                    <br>
                <input type="number" name="hExerciseNr"> <?php if(!empty($_POST) && $_POST["hExerciseNr"] == ""){ echo("Bitte gib eine Aufgabe an."); } ?>
                    
                    <br>
                <input type="datetime" name="hDeadline"> <?php if(!empty($_POST) && $_POST["hDeadline"] == ""){ echo("Bitte gib an, bis wann du die Hausaufgabe abgeben musst."); } ?>
                    <br>
                 <input type="text" name="hSubject"> <?php if(!empty($_POST) && $_POST["hSubject"] == ""){ echo("Bitte gib  ein Thema an."); } ?>
                    <br>        
